...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        // Settings
        Setting::insert([
            ['key' => 'interest_rate',       'value' => '0.30', 'description' => 'Credit interest rate (30%)'],
            ['key' => 'commodity_rate_per_kg','value' => '1000', 'description' => 'Cacao rate: 1kg = 1000 FCFA'],
        ]);
        ...
        $seeds       = Category::create(['name' => 'Semences']);
